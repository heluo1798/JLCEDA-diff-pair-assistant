...
export function openDiffPairAssistant(): void {
	eda.sys_IFrame.openIFrame('/iframe/index.html', 980, 720, 'diff-pair-assistant', {
		maximizeButton: true,
		minimizeButton: true,
		grayscaleMask: true,
	});
...
export function openDiffPairRuleManager(): void {
	eda.sys_IFrame.openIFrame('/iframe/rule-manager.html', 1000, 618, 'diff-pair-rule-manager', {
		maximizeButton: true,
		minimizeButton: true,
		grayscaleMask: true,
	});
